...
const guideExactTranslations: Readonly<Record<string, string>> = {
  ...
  'Amazon Guide': '亚马逊攻略',
  'Assassin Guide': '刺客攻略',
  'Barbarian Guide': '野蛮人攻略',
  'Druid Guide': '德鲁伊攻略',
  'Necromancer Guide': '死灵法师攻略',
  'Paladin Guide': '圣骑士攻略',
  'Sorceress Guide': '法师攻略',
  'Input(s)': '投入物',
  Input: '投入物',
  ...
  'Flawless Topazes': '无瑕黄玉',
  'Flawless Emeralds': '无瑕翡翠',
  'Flawless Diamonds': '无瑕钻石',
  'Flawless Obsidians': '无瑕黑曜石',
  'Flawless Skulls': '无瑕头骨',
  'Flawless Amethysts': '无瑕紫水晶',
  ...
  'Weapon Mastery': '武器精通',
  'DPDNS Cube Formula': 'DPDNS 盒子公式',
  'DPDNS Materials': 'DPDNS 材料',
  'DPDNS Anointment': 'DPDNS 装备祝福',
  'DPDNS Corruption': 'DPDNS 装备腐化',
  'DPDNS End Map': 'DPDNS 终局地图',
  'DPDNS Vessel of Souls': 'DPDNS 灵魂容器',
  'DPDNS Kill Ledger': 'DPDNS 击杀记录',
  'DPDNS Ascendancies': 'DPDNS 职业升华',
  'DPDNS Mythicals': 'DPDNS 神话装备',
  'DPDNS Weapon Bases': 'DPDNS 武器底材',
  'DPDNS Armor Bases': 'DPDNS 防具底材',
  'DPDNS Maps': 'DPDNS 普通地图',
  'DPDNS Skill Information': 'DPDNS 装备技能与佣兵技能',
  'DPDNS Weapon Mastery': 'DPDNS 武器精通',
  'DPDNS Quick Guide': 'DPDNS 简要攻略',
  'DPDNS Amazon Guide': 'DPDNS 亚马逊攻略',
  'DPDNS Assassin Guide': 'DPDNS 刺客攻略',
  'DPDNS Barbarian Guide': 'DPDNS 野蛮人攻略',
  'DPDNS Druid Guide': 'DPDNS 德鲁伊攻略',
  'DPDNS Necromancer Guide': 'DPDNS 死灵法师攻略',
  'DPDNS Paladin Guide': 'DPDNS 圣骑士攻略',
  'DPDNS Sorceress Guide': 'DPDNS 法师攻略',
  Oskills: 'Oskills',
  ...
  'Anvil Stone point': '锻造石点数',
  'Anvil Stone points': '锻造石点数',
  ...
  'Blemished Amethist': '瑕疵紫水晶',
  'Blemished Saphire': '瑕疵蓝宝石',
  'Flawed Tourmaline': '裂开的电气石',
  'Tamoe Highland': '塔莫高地',
  'Rocky Waste': '碎石荒地',
  'Lost City': '遗失城市',
  'Great Marsh': '庞大湿地',
  ...
  '50% Chance for a Flawed Crystal specific to the drop source (LAN)': '50% 几率获得与掉落来源对应的裂开的水晶（LAN）',
  ...
  "Adds Chipped Gem's Helm Bonus": '增加碎裂的宝石的头盔加成',
  "Adds Chipped Gem's Weapon Bonus": '增加碎裂的宝石的武器加成',
  "Adds Chipped Gem's Armor Bonus": '增加碎裂的宝石的护甲加成',
  ...
  "Perfect Gem of Chipped Gem's Color": '与碎裂的宝石同色的完美宝石',
  ...
  '5 Chipped Obsidians': '5 个碎裂的黑曜石',
  '5 Chipped Diamonds': '5 个碎裂的钻石',
...
function translateGuideSpecialFormat(normalized: string): string | null {
  ...
  if (addsGemBonusMatch) return `增加碎裂的宝石的${translateGuideCompositeText(addsGemBonusMatch[1])}加成`;
