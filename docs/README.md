...
| Guide Database | `/database` | Base information, DPDNS-completed native pages, materials, mechanisms, and class guides rendered in a searchable Chinese app UI with compact notes plus categorized material and affix color cues |
