...
| Guide Database | `/database` | Base information, DPDNS-completed native pages, and supplemental guide data rendered in a searchable Chinese app UI with compact notes plus material/affix color cues |
