...
- 升华：查询升华加成、说明和公式文本。
- 资料库：整理基础资料与特色机制子页面，部分页面用 DPDNS 更完整资料作为原生页面来源，包括护甲、武器、前后缀、套装、地图、腐化、涂油、终局地图、灵魂之器、击杀账本、佣兵/Oskill、武器精通等资料；说明文本会合并成紧凑段落，表格内材料需求会按符文、宝石、腐化、器官、方块材料等类别标色，词缀属性也会单独标色。
- 搜索支持中文/英文关键词和精确短语。
